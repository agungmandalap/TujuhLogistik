...
export default class Source extends React.Component {
  ...
  GetStudentIDFunction = (
    ...
    this.props.navigation.navigate('barangEdit', {
      ID: id,
  ...
  <Text style={styles.lightText}>{data.item.namaBarang}</Text>
  <Text style={styles.lightText}>{data.item.hargaJual}</Text>
  <Text style={styles.lightText}>{data.item.hargaBeli}</Text>
  <Text style={styles.lightText}>{data.item.satuan}</Text></TouchableOpacity>
  render(){
